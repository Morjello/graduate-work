    ...
    <main className="main">
      ...
      <div className="about">
        <p className="about-text">
          Научная работа на тему<br></br> &laquo;Автоматизация расчета
          параметров паспорта буровзрывных работ&raquo;<br></br>Выполнил студент
          группы 1181-74 <br></br> Рогознев Даниил под руководством Косарева
          А.А.{' '}
        </p>
      </div>
      {<CalcLinks />}
